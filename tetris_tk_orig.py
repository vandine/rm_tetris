"s Tk - A tetris clone written in Python using the Tkinter GUI library."
...
class shape(object):
    ...
    def move( self, direction ):
        print(" I am moving a shape in the direction %s" %direction)
        """
